...
goog.uri.utils.makeUnique=function(a){return goog.uri.utils.setParam(a,goog.uri.utils.StandardQueryParam.RANDOM,goog.string.getRandomString())};goog.userAgent.platform={};
...
(function(){"undefined"!=typeof document&&(goog.ui.Dialog.ButtonSet.OK=goog.ui.Dialog.ButtonSet.createOk(),goog.ui.Dialog.ButtonSet.OK_CANCEL=goog.ui.Dialog.ButtonSet.createOkCancel(),goog.ui.Dialog.ButtonSet.YES_NO=goog.ui.Dialog.ButtonSet.createYesNo(),goog.ui.Dialog.ButtonSet.YES_NO_CANCEL=goog.ui.Dialog.ButtonSet.createYesNoCancel(),goog.ui.Dialog.ButtonSet.CONTINUE_SAVE_CANCEL=goog.ui.Dialog.ButtonSet.createContinueSaveCancel())})();goog.ui.editor={};goog.ui.editor.AbstractDialog=function(a){goog.events.EventTarget.call(this);this.dom=a;this.dialogInternal_=null};goog.inherits(goog.ui.editor.AbstractDialog,goog.events.EventTarget);goog.ui.editor.AbstractDialog.prototype.show=function(){this.dialogInternal_||(this.dialogInternal_=this.createDialogControl(),this.dialogInternal_.listen(goog.ui.PopupBase.EventType.HIDE,this.handleAfterHide_,!1,this));this.dialogInternal_.setVisible(!0)};
...
goog.ui.editor.AbstractDialog.Builder.prototype.build=function(){this.buttonSet_.isEmpty()&&(this.addOkButton(),this.addCancelButton());this.wrappedDialog_.setButtonSet(this.buttonSet_);var a=this.buttonHandlers_;this.buttonHandlers_=null;this.wrappedDialog_.listen(goog.ui.Dialog.EventType.SELECT,function(b){if(a[b.key])return a[b.key](b)});this.wrappedDialog_.setModal(!0);var b=this.wrappedDialog_;this.wrappedDialog_=null;return b};goog.ui.editor.AbstractDialog.prototype.createDialogControl=goog.abstractMethod;
goog.ui.editor.AbstractDialog.prototype.getOkButtonElement=function(){return this.getButtonElement(goog.ui.Dialog.DefaultButtonKeys.OK)};goog.ui.editor.AbstractDialog.prototype.getCancelButtonElement=function(){return this.getButtonElement(goog.ui.Dialog.DefaultButtonKeys.CANCEL)};goog.ui.editor.AbstractDialog.prototype.getButtonElement=function(a){return this.dialogInternal_.getButtonSet().getButton(a)};goog.ui.editor.AbstractDialog.prototype.createOkEvent=goog.abstractMethod;
...
goog.html.SafeHtmlFormatter.MARKER_="SafeHtmlFormatter:";goog.html.SafeHtmlFormatter.prototype.storeReplacement_=function(a){this.replacementsCount_++;var b="{"+goog.html.SafeHtmlFormatter.MARKER_+this.replacementsCount_+"_"+goog.string.getRandomString()+"}";this.replacements_[goog.string.htmlEscape(b)]=a;return b};goog.ui.editor.messages={};goog.ui.editor.messages.MSG_LINK_CAPTION=goog.getMsg("Link");goog.ui.editor.messages.MSG_EDIT_LINK=goog.getMsg("Edit Link");goog.ui.editor.messages.MSG_TEXT_TO_DISPLAY=goog.getMsg("Text to display:");goog.ui.editor.messages.MSG_LINK_TO=goog.getMsg("Link to:");goog.ui.editor.messages.MSG_ON_THE_WEB=goog.getMsg("Web address");goog.ui.editor.messages.MSG_ON_THE_WEB_TIP=goog.getMsg("Link to a page or file somewhere else on the web");
...
target:"_new"}),endLink:a.endTag("a")});return a.format(b)};goog.ui.editor.messages.MSG_WHAT_URL=goog.getMsg("To what URL should this link go?");goog.ui.editor.messages.MSG_EMAIL_ADDRESS=goog.getMsg("Email address");goog.ui.editor.messages.MSG_EMAIL_ADDRESS_TIP=goog.getMsg("Link to an email address");goog.ui.editor.messages.MSG_INVALID_EMAIL=goog.getMsg("Invalid email address");goog.ui.editor.messages.MSG_WHAT_EMAIL=goog.getMsg("To what email address should this link?");
...
goog.events.InputHandler.prototype.disposeInternal=function(){goog.events.InputHandler.superClass_.disposeInternal.call(this);this.eventHandler_.dispose();this.cancelTimerIfSet_();delete this.element_};goog.dom.InputType={BUTTON:"button",CHECKBOX:"checkbox",COLOR:"color",DATE:"date",DATETIME:"datetime",DATETIME_LOCAL:"datetime-local",EMAIL:"email",FILE:"file",HIDDEN:"hidden",IMAGE:"image",MENU:"menu",MONTH:"month",NUMBER:"number",PASSWORD:"password",RADIO:"radio",RANGE:"range",RESET:"reset",SEARCH:"search",SELECT_MULTIPLE:"select-multiple",SELECT_ONE:"select-one",SUBMIT:"submit",TEL:"tel",TEXT:"text",TEXTAREA:"textarea",TIME:"time",URL:"url",WEEK:"week"};goog.ui.registry={};goog.ui.registry.getDefaultRenderer=function(a){for(var b;a;){b=goog.getUid(a);if(b=goog.ui.registry.defaultRenderers_[b])break;a=a.superClass_?a.superClass_.constructor:null}return b?goog.isFunction(b.getInstance)?b.getInstance():new b:null};goog.ui.registry.setDefaultRenderer=function(a,b){if(!goog.isFunction(a))throw Error("Invalid component class "+a);if(!goog.isFunction(b))throw Error("Invalid renderer class "+b);a=goog.getUid(a);goog.ui.registry.defaultRenderers_[a]=b};
...
goog.ui.registry.getDecorator=function(a){goog.asserts.assert(a);for(var b=goog.dom.classlist.get(a),c=0,d=b.length;c<d;c++)if(a=goog.ui.registry.getDecoratorByClassName(b[c]))return a;return null};goog.ui.registry.reset=function(){goog.ui.registry.defaultRenderers_={};goog.ui.registry.decoratorFunctions_={}};goog.ui.registry.defaultRenderers_={};goog.ui.registry.decoratorFunctions_={};goog.ui.ControlRenderer=function(){};goog.addSingletonGetter(goog.ui.ControlRenderer);goog.tagUnsealableClass(goog.ui.ControlRenderer);goog.ui.ControlRenderer.getCustomRenderer=function(a,b){a=new a;a.getCssClass=function(){return b};return a};goog.ui.ControlRenderer.CSS_CLASS="goog-control";goog.ui.ControlRenderer.IE6_CLASS_COMBINATIONS=[];
...
goog.ui.ContainerRenderer.prototype.getClassNames=function(a){var b=this.getCssClass(),c=a.getOrientation()==goog.ui.Container.Orientation.HORIZONTAL;c=[b,c?b+"-horizontal":b+"-vertical"];a.isEnabled()||c.push(b+"-disabled");return c};goog.ui.ContainerRenderer.prototype.getDefaultOrientation=function(){return goog.ui.Container.Orientation.VERTICAL};goog.ui.TabBarRenderer=function(){goog.ui.ContainerRenderer.call(this,goog.a11y.aria.Role.TAB_LIST)};goog.inherits(goog.ui.TabBarRenderer,goog.ui.ContainerRenderer);goog.addSingletonGetter(goog.ui.TabBarRenderer);goog.tagUnsealableClass(goog.ui.TabBarRenderer);goog.ui.TabBarRenderer.CSS_CLASS="goog-tab-bar";goog.ui.TabBarRenderer.prototype.getCssClass=function(){return goog.ui.TabBarRenderer.CSS_CLASS};
...
goog.ui.TabBar.getOrientationFromLocation=function(a){return a==goog.ui.TabBar.Location.START||a==goog.ui.TabBar.Location.END?goog.ui.Container.Orientation.VERTICAL:goog.ui.Container.Orientation.HORIZONTAL};goog.ui.registry.setDecoratorByClassName(goog.ui.TabBarRenderer.CSS_CLASS,function(){return new goog.ui.TabBar});goog.ui.editor.TabPane=function(a,b){goog.ui.Component.call(this,a);this.eventHandler_=new goog.events.EventHandler(this);this.registerDisposable(this.eventHandler_);this.tabBar_=new goog.ui.TabBar(goog.ui.TabBar.Location.START,void 0,this.dom_);this.tabBar_.setFocusable(!1);this.tabContent_=this.dom_.createDom("DIV",{className:"goog-tab-content"});this.visibleContent_=this.selectedRadio_=null;b&&(a=new goog.ui.Control(b,void 0,this.dom_),a.addClassName("tr-tabpane-caption"),a.setEnabled(!1),this.tabBar_.addChild(a,
!0))};goog.inherits(goog.ui.editor.TabPane,goog.ui.Component);goog.ui.editor.TabPane.prototype.getCurrentTabId=function(){return this.tabBar_.getSelectedTab().getId()};goog.ui.editor.TabPane.prototype.setSelectedTabId=function(a){this.tabBar_.setSelectedTab(this.tabBar_.getChild(a))};
goog.ui.editor.TabPane.prototype.addTab=function(a,b,c,d,e){d=this.dom_.createDom("INPUT",{name:d,type:goog.dom.InputType.RADIO});b=new goog.ui.Tab([d,this.dom_.createTextNode(b)],void 0,this.dom_);b.setId(a);b.setTooltip(c);this.tabBar_.addChild(b,!0);this.eventHandler_.listen(d,[goog.events.EventType.SELECT,goog.events.EventType.CLICK],goog.bind(this.tabBar_.setSelectedTab,this.tabBar_,b));e.id=a+"-tab";this.tabContent_.appendChild(e);goog.style.setElementShown(e,!1)};
goog.ui.editor.TabPane.prototype.enterDocument=function(){goog.ui.editor.TabPane.superClass_.enterDocument.call(this);var a=this.getElement();goog.asserts.assert(a);goog.dom.classlist.add(a,"tr-tabpane");this.addChild(this.tabBar_,!0);this.eventHandler_.listen(this.tabBar_,goog.ui.Component.EventType.SELECT,this.handleTabSelect_);a.appendChild(this.tabContent_);a.appendChild(this.dom_.createDom("DIV",{className:"goog-tab-bar-clear"}))};
goog.ui.editor.TabPane.prototype.handleTabSelect_=function(a){a=a.target;this.visibleContent_&&goog.style.setElementShown(this.visibleContent_,!1);this.visibleContent_=this.dom_.getElement(a.getId()+"-tab");goog.style.setElementShown(this.visibleContent_,!0);this.selectedRadio_&&(this.selectedRadio_.checked=!1);this.selectedRadio_=goog.dom.getElementsByTagName("INPUT",a.getElementStrict())[0];this.selectedRadio_.checked=!0};goog.window={};goog.window.DEFAULT_POPUP_HEIGHT=500;goog.window.DEFAULT_POPUP_WIDTH=690;goog.window.DEFAULT_POPUP_TARGET="google_popup";goog.window.createFakeWindow_=function(){return{}};
...
goog.ui.editor.LinkDialog.prototype.show=function(){goog.ui.editor.LinkDialog.superClass_.show.call(this);this.selectAppropriateTab_(this.textToDisplayInput_.value,this.getTargetUrl_());this.focusTextToDisplayOnOpenIfEmpty_&&!this.targetLink_.getCurrentText()&&goog.editor.focus.focusInputField(this.textToDisplayInput_);this.syncOkButton_();this.showOpenLinkInNewWindow_&&(this.targetLink_.isNew()||(this.isOpenLinkInNewWindowChecked_="_blank"==this.targetLink_.getAnchor().target),this.openInNewWindowCheckbox_.checked=
this.isOpenLinkInNewWindowChecked_);this.showRelNoFollow_&&(this.relNoFollowCheckbox_.checked=goog.ui.editor.LinkDialog.hasNoFollow(this.targetLink_.getAnchor().rel))};goog.ui.editor.LinkDialog.prototype.hide=function(){this.disableAutogenFlag_(!1);goog.ui.editor.LinkDialog.superClass_.hide.call(this)};goog.ui.editor.LinkDialog.prototype.setTextToDisplayVisible=function(a){this.textToDisplayDiv_&&goog.style.setStyle(this.textToDisplayDiv_,"display",a?"block":"none")};
goog.ui.editor.LinkDialog.prototype.setStopReferrerLeaks=function(a){this.stopReferrerLeaks_=a};goog.ui.editor.LinkDialog.prototype.setStopTabNabbing=function(a){this.stopTabNabbing_=a};goog.ui.editor.LinkDialog.prototype.setAutogenFeatureEnabled=function(a){this.autogenFeatureEnabled_=a};goog.ui.editor.LinkDialog.hasNoFollow=function(a){return goog.ui.editor.LinkDialog.NO_FOLLOW_REGEX_.test(a)};
...
goog.ui.editor.LinkDialog.prototype.createOkEvent=function(){return this.tabPane_.getCurrentTabId()==goog.ui.editor.LinkDialog.Id_.EMAIL_ADDRESS_TAB?this.createOkEventFromEmailTab_():this.createOkEventFromWebTab_()};goog.ui.editor.LinkDialog.NO_FOLLOW_REGEX_=/\bnofollow\b/i;
goog.ui.editor.LinkDialog.prototype.createDialogContent_=function(){this.textToDisplayDiv_=this.buildTextToDisplayDiv_();var a=this.dom.createDom("DIV",null,this.textToDisplayDiv_);this.tabPane_=new goog.ui.editor.TabPane(this.dom,goog.ui.editor.messages.MSG_LINK_TO);this.registerDisposable(this.tabPane_);this.tabPane_.addTab(goog.ui.editor.LinkDialog.Id_.ON_WEB_TAB,goog.ui.editor.messages.MSG_ON_THE_WEB,goog.ui.editor.messages.MSG_ON_THE_WEB_TIP,goog.ui.editor.LinkDialog.BUTTON_GROUP_,this.buildTabOnTheWeb_());
this.tabPane_.addTab(goog.ui.editor.LinkDialog.Id_.EMAIL_ADDRESS_TAB,goog.ui.editor.messages.MSG_EMAIL_ADDRESS,goog.ui.editor.messages.MSG_EMAIL_ADDRESS_TIP,goog.ui.editor.LinkDialog.BUTTON_GROUP_,this.buildTabEmailAddress_());this.tabPane_.render(a);this.eventHandler_.listen(this.tabPane_,goog.ui.Component.EventType.SELECT,this.onChangeTab_);this.showOpenLinkInNewWindow_&&a.appendChild(this.buildOpenInNewWindowDiv_());this.showRelNoFollow_&&a.appendChild(this.buildRelNoFollowDiv_());return a};
goog.ui.editor.LinkDialog.prototype.buildTextToDisplayDiv_=function(){var a=this.dom.createTable(1,2);a.cellSpacing="0";a.cellPadding="0";a.style.fontSize="10pt";var b=this.dom.createDom("DIV"),c=goog.html.SafeHtml.create("span",{style:{position:"relative",bottom:"2px","padding-right":"1px","white-space":"nowrap"},id:goog.ui.editor.LinkDialog.Id_.TEXT_TO_DISPLAY_LABEL},[goog.ui.editor.messages.MSG_TEXT_TO_DISPLAY,goog.string.Unicode.NBSP]);goog.dom.safe.setInnerHtml(a.rows[0].cells[0],c);c=this.textToDisplayInput_=
this.dom.createDom("INPUT",{id:goog.ui.editor.LinkDialog.Id_.TEXT_TO_DISPLAY});goog.style.setStyle(c,"width","98%");goog.style.setStyle(a.rows[0].cells[1],"width","100%");goog.dom.appendChild(a.rows[0].cells[1],c);goog.a11y.aria.setState(c,goog.a11y.aria.State.LABELLEDBY,goog.ui.editor.LinkDialog.Id_.TEXT_TO_DISPLAY_LABEL);c.value=this.targetLink_.getCurrentText();this.textInputHandler_=new goog.events.InputHandler(c);this.registerDisposable(this.textInputHandler_);this.eventHandler_.listen(this.textInputHandler_,
goog.events.InputHandler.EventType.INPUT,this.onTextToDisplayEdit_);goog.dom.appendChild(b,a);return b};goog.ui.editor.LinkDialog.prototype.buildOpenInNewWindowDiv_=function(){this.openInNewWindowCheckbox_=this.dom.createDom("INPUT",{type:goog.dom.InputType.CHECKBOX});return this.dom.createDom("DIV",null,this.dom.createDom("LABEL",null,this.openInNewWindowCheckbox_,goog.ui.editor.messages.MSG_OPEN_IN_NEW_WINDOW))};
goog.ui.editor.LinkDialog.prototype.buildRelNoFollowDiv_=function(){var a=new goog.html.SafeHtmlFormatter,b=goog.getMsg("Add '{$relNoFollow}' attribute ({$linkStart}Learn more{$linkEnd})",{relNoFollow:"rel=nofollow",linkStart:a.startTag("a",{href:"http://support.google.com/webmasters/bin/answer.py?hl=en&answer=96569",target:"_blank"}),linkEnd:a.endTag("a")});this.relNoFollowCheckbox_=this.dom.createDom("INPUT",{type:goog.dom.InputType.CHECKBOX});return this.dom.createDom("DIV",null,this.dom.createDom("LABEL",
null,this.relNoFollowCheckbox_,goog.dom.safeHtmlToNode(a.format(b))))};
goog.ui.editor.LinkDialog.prototype.buildTabOnTheWeb_=function(){var a=this.dom.createElement("DIV"),b=this.dom.createDom("DIV",{},this.dom.createDom("B",{},goog.ui.editor.messages.MSG_WHAT_URL)),c=this.dom.createDom("INPUT",{id:goog.ui.editor.LinkDialog.Id_.ON_WEB_INPUT,className:goog.ui.editor.LinkDialog.TARGET_INPUT_CLASSNAME_});goog.a11y.aria.setState(c,goog.a11y.aria.State.LABELLEDBY,goog.ui.editor.LinkDialog.Id_.ON_WEB_TAB);if(!goog.userAgent.IE||goog.userAgent.isVersionOrHigher("10"))c.type=
goog.dom.InputType.URL;goog.editor.BrowserFeature.NEEDS_99_WIDTH_IN_STANDARDS_MODE&&goog.editor.node.isStandardsMode(c)&&(c.style.width="99%");var d=this.dom.createDom("DIV",null,c);this.urlInputHandler_=new goog.events.InputHandler(c);this.registerDisposable(this.urlInputHandler_);this.eventHandler_.listen(this.urlInputHandler_,goog.events.InputHandler.EventType.INPUT,this.onUrlOrEmailInputChange_);c=new goog.ui.Button(goog.ui.editor.messages.MSG_TEST_THIS_LINK,goog.ui.LinkButtonRenderer.getInstance(),
this.dom);c.render(d);c.getElement().style.marginTop="1em";this.eventHandler_.listen(c,goog.ui.Component.EventType.ACTION,this.onWebTestLink_);c=this.dom.createDom("DIV",goog.ui.editor.LinkDialog.EXPLANATION_TEXT_CLASSNAME_);goog.dom.safe.setInnerHtml(c,goog.ui.editor.messages.getTrLinkExplanationSafeHtml());a.appendChild(b);a.appendChild(d);a.appendChild(c);return a};
goog.ui.editor.LinkDialog.prototype.buildTabEmailAddress_=function(){var a=this.dom.createDom("DIV"),b=this.dom.createDom("DIV",{},this.dom.createDom("B",{},goog.ui.editor.messages.MSG_WHAT_EMAIL));goog.dom.appendChild(a,b);b=this.dom.createDom("INPUT",{id:goog.ui.editor.LinkDialog.Id_.EMAIL_ADDRESS_INPUT,className:goog.ui.editor.LinkDialog.TARGET_INPUT_CLASSNAME_});goog.a11y.aria.setState(b,goog.a11y.aria.State.LABELLEDBY,goog.ui.editor.LinkDialog.Id_.EMAIL_ADDRESS_TAB);goog.editor.BrowserFeature.NEEDS_99_WIDTH_IN_STANDARDS_MODE&&
goog.editor.node.isStandardsMode(b)&&(b.style.width="99%");goog.dom.appendChild(a,b);this.emailInputHandler_=new goog.events.InputHandler(b);this.registerDisposable(this.emailInputHandler_);this.eventHandler_.listen(this.emailInputHandler_,goog.events.InputHandler.EventType.INPUT,this.onUrlOrEmailInputChange_);goog.dom.appendChild(a,this.dom.createDom("DIV",{id:goog.ui.editor.LinkDialog.Id_.EMAIL_WARNING,className:goog.ui.editor.LinkDialog.EMAIL_WARNING_CLASSNAME_,style:"visibility:hidden"},goog.ui.editor.messages.MSG_INVALID_EMAIL));
this.emailWarning_&&(b=this.dom.createDom("DIV",goog.ui.editor.LinkDialog.EXPLANATION_TEXT_CLASSNAME_),goog.dom.safe.setInnerHtml(b,this.emailWarning_),goog.dom.appendChild(a,b));return a};goog.ui.editor.LinkDialog.prototype.getTargetUrl_=function(){return this.targetLink_.getAnchor().getAttribute("href")||""};
...
goog.ui.editor.LinkDialog.prototype.syncOkButton_=function(){if(this.tabPane_.getCurrentTabId()==goog.ui.editor.LinkDialog.Id_.EMAIL_ADDRESS_TAB){var a=this.dom.getElement(goog.ui.editor.LinkDialog.Id_.EMAIL_ADDRESS_INPUT).value;this.toggleInvalidEmailWarning_(""!=a&&!goog.editor.Link.isLikelyEmailAddress(a))}else if(this.tabPane_.getCurrentTabId()==goog.ui.editor.LinkDialog.Id_.ON_WEB_TAB)a=this.dom.getElement(goog.ui.editor.LinkDialog.Id_.ON_WEB_INPUT).value;else return;this.getOkButtonElement().disabled=
goog.string.isEmptyOrWhitespace(a)};goog.ui.editor.LinkDialog.prototype.toggleInvalidEmailWarning_=function(a){this.dom.getElement(goog.ui.editor.LinkDialog.Id_.EMAIL_WARNING).style.visibility=a?"visible":"hidden"};goog.ui.editor.LinkDialog.prototype.onTextToDisplayEdit_=function(){""==this.textToDisplayInput_.value?this.setAutogenFlag_(!0):this.setAutogenFlagFromCurInput_()};
goog.ui.editor.LinkDialog.prototype.createOkEventFromWebTab_=function(){var a=this.dom.getElement(goog.ui.editor.LinkDialog.Id_.ON_WEB_INPUT).value;if(goog.editor.Link.isLikelyEmailAddress(a))return this.createOkEventFromEmailTab_(goog.ui.editor.LinkDialog.Id_.ON_WEB_INPUT);0>a.search(/:/)&&(a=goog.string.trimLeft(a));return this.createOkEventFromUrl_(a)};
...
goog.ui.editor.LinkDialog.prototype.onWebTestLink_=function(){var a=this.dom.getElement(goog.ui.editor.LinkDialog.Id_.ON_WEB_INPUT).value;0>a.search(/:/)&&(a=goog.string.trimLeft(a));if(this.dispatchEvent(new goog.ui.editor.LinkDialog.BeforeTestLinkEvent(a))){var b=this.dom.getWindow(),c=goog.dom.getViewportSize(b);goog.window.open(a,{target:"_blank",width:Math.max(c.width-50,50),height:Math.max(c.height-50,50),toolbar:!0,scrollbars:!0,location:!0,statusbar:!1,menubar:!0,resizable:!0,noreferrer:this.stopReferrerLeaks_,
noopener:this.stopTabNabbing_},b)}};goog.ui.editor.LinkDialog.prototype.onUrlOrEmailInputChange_=function(){this.autogenerateTextToDisplay_?this.setTextToDisplayFromAuto_():""==this.textToDisplayInput_.value&&this.setAutogenFlagFromCurInput_();this.syncOkButton_()};
...
goog.ui.editor.LinkDialog.Id_={TEXT_TO_DISPLAY:"linkdialog-text",TEXT_TO_DISPLAY_LABEL:"linkdialog-text-label",ON_WEB_TAB:"linkdialog-onweb",ON_WEB_INPUT:"linkdialog-onweb-tab-input",EMAIL_ADDRESS_TAB:"linkdialog-email",EMAIL_ADDRESS_INPUT:"linkdialog-email-tab-input",EMAIL_WARNING:"linkdialog-email-warning",TAB_INPUT_SUFFIX:"-tab-input"};goog.ui.editor.LinkDialog.BUTTON_GROUP_="linkdialog-buttons";goog.ui.editor.LinkDialog.TARGET_INPUT_CLASSNAME_="tr-link-dialog-target-input";
goog.ui.editor.LinkDialog.EMAIL_WARNING_CLASSNAME_="tr-link-dialog-email-warning";goog.ui.editor.LinkDialog.EXPLANATION_TEXT_CLASSNAME_="tr-link-dialog-explanation-text";goog.editor.plugins.LinkDialogPlugin=function(){goog.editor.plugins.AbstractDialogPlugin.call(this,goog.editor.Command.MODAL_LINK_EDITOR);this.eventHandler_=new goog.events.EventHandler(this);this.safeToOpenSchemes_=["http","https","ftp"]};goog.inherits(goog.editor.plugins.LinkDialogPlugin,goog.editor.plugins.AbstractDialogPlugin);goog.editor.plugins.LinkDialogPlugin.prototype.showOpenLinkInNewWindow_=!1;goog.editor.plugins.LinkDialogPlugin.prototype.focusTextToDisplayOnOpenIfEmpty_=!1;
...
this.attributeHandlers_[d],c(b,e,a);c=goog.html.sanitizer.HtmlSanitizer.attrIdentifier_(null,c);return c in this.attributeHandlers_?(c=this.attributeHandlers_[c],c(b,e,a)):null};goog.html.sanitizer.HtmlSanitizer.sanitize=function(a){return(new goog.html.sanitizer.HtmlSanitizer.Builder).build().sanitize(a)};goog.ui.MenuSeparatorRenderer=function(){goog.ui.ControlRenderer.call(this)};goog.inherits(goog.ui.MenuSeparatorRenderer,goog.ui.ControlRenderer);goog.addSingletonGetter(goog.ui.MenuSeparatorRenderer);goog.ui.MenuSeparatorRenderer.CSS_CLASS="goog-menuseparator";goog.ui.MenuSeparatorRenderer.prototype.createDom=function(a){return a.getDomHelper().createDom("DIV",this.getCssClass())};
...
goog.ui.MenuItem.prototype.getPreferredAriaRole=function(){return this.isSupportedState(goog.ui.Component.State.CHECKED)?goog.a11y.aria.Role.MENU_ITEM_CHECKBOX:this.isSupportedState(goog.ui.Component.State.SELECTED)?goog.a11y.aria.Role.MENU_ITEM_RADIO:goog.ui.MenuItem.superClass_.getPreferredAriaRole.call(this)};goog.ui.MenuItem.prototype.getParent=function(){return goog.ui.Control.prototype.getParent.call(this)};goog.ui.MenuItem.prototype.getParentEventTarget=function(){return goog.ui.Control.prototype.getParentEventTarget.call(this)};goog.positioning={};goog.positioning.CornerBit={BOTTOM:1,CENTER:2,RIGHT:4,FLIP_RTL:8};
...
goog.positioning.flipCornerVertical=function(a){return a^goog.positioning.CornerBit.BOTTOM};goog.positioning.flipCorner=function(a){return a^goog.positioning.CornerBit.BOTTOM^goog.positioning.CornerBit.RIGHT};goog.ui.MenuSeparator=function(a){goog.ui.Separator.call(this,goog.ui.MenuSeparatorRenderer.getInstance(),a)};goog.inherits(goog.ui.MenuSeparator,goog.ui.Separator);goog.ui.registry.setDecoratorByClassName(goog.ui.MenuSeparatorRenderer.CSS_CLASS,function(){return new goog.ui.Separator});goog.ui.MenuHeaderRenderer=function(){goog.ui.ControlRenderer.call(this)};goog.inherits(goog.ui.MenuHeaderRenderer,goog.ui.ControlRenderer);goog.addSingletonGetter(goog.ui.MenuHeaderRenderer);goog.ui.MenuHeaderRenderer.CSS_CLASS="goog-menuheader";goog.ui.MenuHeaderRenderer.prototype.getCssClass=function(){return goog.ui.MenuHeaderRenderer.CSS_CLASS};goog.ui.MenuHeader=function(a,b,c){goog.ui.Control.call(this,a,c||goog.ui.MenuHeaderRenderer.getInstance(),b);this.setSupportedState(goog.ui.Component.State.DISABLED,!1);this.setSupportedState(goog.ui.Component.State.HOVER,!1);this.setSupportedState(goog.ui.Component.State.ACTIVE,!1);this.setSupportedState(goog.ui.Component.State.FOCUSED,!1);this.setStateInternal(goog.ui.Component.State.DISABLED)};goog.inherits(goog.ui.MenuHeader,goog.ui.Control);
...
goog.editor.plugins.UndoRedo.CursorPosition_.computeEndOffsetIE_=function(a){var b=a.duplicate(),c=a.text,d=c.length;b.collapse(!0);b.moveEnd("character",d);for(var e,f=10;(e=b.compareEndPoints("EndToEnd",a))&&(d-=e,b.moveEnd("character",-e),--f,0!=f););a=0;for(b=c.indexOf("\n\r");-1!=b;)++a,b=c.indexOf("\n\r",b+1);return d+a};goog.cssom={};goog.cssom.CssRuleType={STYLE:1,IMPORT:3,MEDIA:4,FONT_FACE:5,PAGE:6,NAMESPACE:7};goog.cssom.getAllCssText=function(a){return goog.cssom.getAllCss_(a||document.styleSheets,!0)};goog.cssom.getAllCssStyleRules=function(a){return goog.cssom.getAllCss_(a||document.styleSheets,!1)};goog.cssom.getCssRulesFromStyleSheet=function(a){var b=null;try{b=a.cssRules||a.rules}catch(c){if(15==c.code)throw c.styleSheet=a,c;}return b};
goog.cssom.getAllCssStyleSheets=function(a,b){var c=[];a=a||document.styleSheets;b=goog.isDef(b)?b:!1;if(a.imports&&a.imports.length)for(var d=0,e=a.imports.length;d<e;d++)goog.array.extend(c,goog.cssom.getAllCssStyleSheets(a.imports[d]));else if(a.length)for(d=0,e=a.length;d<e;d++)goog.array.extend(c,goog.cssom.getAllCssStyleSheets(a[d]));else{var f=goog.cssom.getCssRulesFromStyleSheet(a);if(f&&f.length){d=0;e=f.length;for(var g;d<e;d++)g=f[d],g.styleSheet&&goog.array.extend(c,goog.cssom.getAllCssStyleSheets(g.styleSheet))}}!(a.type||
a.rules||a.cssRules)||a.disabled&&!b||c.push(a);return c};goog.cssom.getCssTextFromCssRule=function(a){var b="";a.cssText?b=a.cssText:a.style&&a.style.cssText&&a.selectorText&&(b=a.style.cssText.replace(/\s*-closure-parent-stylesheet:\s*\[object\];?\s*/gi,"").replace(/\s*-closure-rule-index:\s*[\d]+;?\s*/gi,""),b=a.selectorText+" { "+b+" }");return b};
goog.cssom.getCssRuleIndexInParentStyleSheet=function(a,b){if(a.style&&a.style["-closure-rule-index"])return a.style["-closure-rule-index"];b=b||goog.cssom.getParentStyleSheet(a);if(!b)throw Error("Cannot find a parentStyleSheet.");if((b=goog.cssom.getCssRulesFromStyleSheet(b))&&b.length)for(var c=0,d=b.length,e;c<d;c++)if(e=b[c],e==a)return c;return-1};goog.cssom.getParentStyleSheet=function(a){return a.parentStyleSheet||a.style&&a.style["-closure-parent-stylesheet"]};
...
goog.cssom.iframe.style.CssRuleSet_.prototype.setSelectorsFromString=function(a){this.selectors=[];a=a.split(/,\s*/gm);for(var b=0;b<a.length;b++){var c=a[b];0<c.length&&this.selectors.push(new goog.cssom.iframe.style.CssSelector_(c))}};goog.cssom.iframe.style.CssRuleSet_.prototype.clone=function(){var a=new goog.cssom.iframe.style.CssRuleSet_;a.selectors=this.selectors.concat();a.declarationText=this.declarationText;return a};
...
goog.cssom.iframe.style.CssRuleSet_.prototype.writeToArray=function(a){for(var b=this.selectors.length,c=!1,d=0;d<b;d++){for(var e=this.selectors[d].parts,f=e.length,g=0;g<f;g++)a.push(e[g].inputString_,goog.cssom.iframe.style.SELECTOR_PART_DELIMITER_);d<b-1&&a.push(goog.cssom.iframe.style.SELECTOR_DELIMITER_);goog.userAgent.GECKO&&!goog.userAgent.isVersionOrHigher("1.9a")&&(c=c||goog.cssom.iframe.style.selectorPartAnchorRegex_.test(e[f-1].inputString_))}b=this.declarationText;c&&(b=goog.cssom.iframe.style.makeColorRuleImportant_(b));
a.push(goog.cssom.iframe.style.DECLARATION_START_DELIMITER_,b,goog.cssom.iframe.style.DECLARATION_END_DELIMITER_)};goog.cssom.iframe.style.colorImportantReplaceRegex_=/(^|;|{)\s*color:([^;]+);/g;goog.cssom.iframe.style.makeColorRuleImportant_=function(a){return a.replace(goog.cssom.iframe.style.colorImportantReplaceRegex_,"$1 color: $2 ! important; ")};goog.cssom.iframe.style.CssSelector_=function(a){this.ancestryMatchCache_={};a&&this.setPartsFromString_(a)};
goog.cssom.iframe.style.CssSelector_.prototype.setPartsFromString_=function(a){var b=[];a=a.split(/\s+/gm);for(var c=0;c<a.length;c++)if(a[c]){var d=new goog.cssom.iframe.style.CssSelectorPart_(a[c]);b.push(d)}this.parts=b};
goog.cssom.iframe.style.CssSelector_.prototype.matchElementAncestry=function(a){var b=a.uid;if(this.ancestryMatchCache_[b])return this.ancestryMatchCache_[b];for(var c=0,d=null,e=null,f=a.nodes,g=f.length,h=0;h<=this.parts.length;h++){for(a=this.parts[h];c<g;){var k=f[c];if(a&&a.testElement(k)){d={elementIndex:c,selectorPartIndex:h};c++;break}else e&&e.testElement(k)&&(d={elementIndex:c,selectorPartIndex:h-1});c++}e=a}return this.ancestryMatchCache_[b]=d};
goog.cssom.iframe.style.CssSelectorPart_=function(a){var b=goog.cssom.iframe.style.CssSelectorPart_.instances_[a];if(b)return b;b=a.match(/[#\.]/)?a.split(/(?=[#\.])/):[a];for(var c={},d=0;d<b.length;d++){var e=b[d];"."==e.charAt(0)?c.className=e.substring(1,e.length):"#"==e.charAt(0)?c.id=e.substring(1,e.length):c.tagName=e.toUpperCase()}this.inputString_=a;this.matchProperties_=c;this.testedElements_={};goog.cssom.iframe.style.CssSelectorPart_.instances_[a]=this};
goog.cssom.iframe.style.CssSelectorPart_.instances_={};goog.cssom.iframe.style.CssSelectorPart_.prototype.testElement=function(a){var b=a.uid,c=this.testedElements_[b];if("undefined"!=typeof c)return c;var d=this.matchProperties_;c=d.tagName;var e=d.className;d=d.id;var f=!0;c&&"*"!=c&&c!=a.nodeName?f=!1:d&&d!=a.id?f=!1:e&&!a.classNames[e]&&(f=!1);return this.testedElements_[b]=f};
goog.cssom.iframe.style.NodeAncestry_=function(a){var b=goog.getUid(a),c=goog.cssom.iframe.style.NodeAncestry_.instances_[b];if(c)return c;c=[];do{var d={id:a.id,nodeName:a.nodeName};d.uid=goog.getUid(d);var e={};if(a.className)for(var f=goog.dom.classlist.get(goog.asserts.assertElement(a)),g=0;g<f.length;g++)e[f[g]]=1;d.classNames=e;c.unshift(d)}while(a=a.parentNode);this.nodes=c;this.uid=goog.getUid(this);goog.cssom.iframe.style.NodeAncestry_.instances_[b]=this};
goog.cssom.iframe.style.NodeAncestry_.instances_={};goog.cssom.iframe.style.resetDomCache=function(){goog.cssom.iframe.style.NodeAncestry_.instances_={}};goog.cssom.iframe.style.getRuleSetsFromDocument_=function(a){var b=[];a=goog.cssom.getAllCssStyleSheets(a.styleSheets);for(var c=0,d;d=a[c];c++)if((d=goog.cssom.getCssRulesFromStyleSheet(d))&&d.length)for(var e=0,f=d.length;e<f;e++){var g=new goog.cssom.iframe.style.CssRuleSet_;g.initializeFromCssRule(d[e])&&b.push(g)}return b};
goog.cssom.iframe.style.ruleSetCache_={};goog.cssom.iframe.style.ruleSetCache_.cache_={};goog.cssom.iframe.style.ruleSetCache_.loadRuleSetsForDocument=function(a){var b=goog.getUid(a);goog.cssom.iframe.style.ruleSetCache_.cache_[b]=goog.cssom.iframe.style.getRuleSetsFromDocument_(a)};
goog.cssom.iframe.style.ruleSetCache_.getRuleSetsForDocument=function(a){var b=goog.getUid(a),c=goog.cssom.iframe.style.ruleSetCache_.cache_;c[b]||goog.cssom.iframe.style.ruleSetCache_.loadRuleSetsForDocument(a);a=c[b];b=[];for(c=0;c<a.length;c++)b.push(a[c].clone());return b};goog.cssom.iframe.style.inheritedProperties_="color visibility quotes list-style-type list-style-image list-style-position list-style page-break-inside orphans widows font-family font-style font-variant font-weight text-indent text-align text-transform white-space caption-side border-collapse border-spacing empty-cells cursor".split(" ");
...
goog.cssom.iframe.style.getElementContext=function(a,b,c){var d=a.ownerDocument;b&&goog.cssom.iframe.style.ruleSetCache_.loadRuleSetsForDocument(d);b=goog.cssom.iframe.style.ruleSetCache_.getRuleSetsForDocument(d);var e=new goog.cssom.iframe.style.NodeAncestry_(a),f=new goog.cssom.iframe.style.CssSelectorPart_("body");for(d=0;d<b.length;d++)for(var g=b[d].selectors,h=g.length,k=0;k<h;k++){var l=g[k],m=l.matchElementAncestry(e);if(m){var n=m.selectorPartIndex;l=l.parts;var p=l.length-1;m.elementIndex==
e.nodes.length-1||n<p?(m=l.concat(),m.splice(0,n+1,f),n=new goog.cssom.iframe.style.CssSelector_,n.parts=m,g.push(n)):0<n&&n==p&&(n=new goog.cssom.iframe.style.CssSelector_,n.parts=[f,l[p]],g.push(n))}}f=new goog.cssom.iframe.style.CssRuleSet_;h=goog.cssom.iframe.style.getComputedStyleObject_(a);d=new goog.cssom.iframe.style.CssSelector_;d.parts=[new goog.cssom.iframe.style.CssSelectorPart_("html")];f.selectors=[d];g={};for(d=0;e=goog.cssom.iframe.style.inheritedProperties_[d];d++)g[e]=h[goog.string.toCamelCase(e)];
f.setDeclarationTextFromObject(g);b.push(f);f=new goog.cssom.iframe.style.CssRuleSet_;g=new goog.cssom.iframe.style.CssSelector_;g.parts=[new goog.cssom.iframe.style.CssSelectorPart_("body")];k={position:"relative",top:"0",left:"0",right:"auto",display:"block",visibility:"visible"};for(d=0;e=goog.cssom.iframe.style.textProperties_[d];d++)k[e]=h[goog.string.toCamelCase(e)];c&&goog.cssom.iframe.style.isTransparentValue_(h.backgroundColor)&&(a=goog.cssom.iframe.style.getBackgroundContext(a),k["background-color"]=
a.backgroundColor,c=h.backgroundImage,c&&"none"!=c||(k["background-image"]=a.backgroundImage,k["background-repeat"]=a.backgroundRepeat,k["background-position"]=a.backgroundPosition));f.setDeclarationTextFromObject(k,!0);f.selectors=[g];b.push(f);a=[];h=b.length;for(d=0;d<h;d++)b[d].writeToArray(a);return a.join("")};goog.cssom.iframe.style.isTransparentValue_=function(a){return"transparent"==a||"rgba(0, 0, 0, 0)"==a};
...
goog.editor.SeamlessField.prototype.handleOuterDocChange_=function(){this.isEventStopped(goog.editor.Field.EventType.CHANGE)||this.sizeIframeToWrapperGecko_()};
goog.editor.SeamlessField.prototype.sizeIframeToBodyHeightGecko_=function(){if(this.acquireSizeIframeLockGecko_()){var a=!1,b=this.getEditableIframe();if(b){var c=this.getIframeBodyHeightGecko_();this.minHeight_&&(c=Math.max(c,this.minHeight_));parseInt(goog.style.getStyle(b,"height"),10)!=c&&(b.style.height=c+"px",a=!0)}this.releaseSizeIframeLockGecko_();a&&this.dispatchEvent(goog.editor.Field.EventType.IFRAME_RESIZED)}};
...
goog.editor.SeamlessField.prototype.installStyles=function(){this.usesIframe()||goog.editor.SeamlessField.haveInstalledCss_||(this.cssStyles.getTypedStringValue()&&goog.style.installSafeStyleSheet(this.cssStyles,this.getElement()),goog.editor.SeamlessField.haveInstalledCss_=!0)};
...
a.preventDefault(),!0)};var editor={start:{}};
