...
goog.editor.plugins.ImageBubble.prototype.sizeTo_=function(a,b,c){this.getFieldObject().dispatchBeforeChange();var d=this.getTargetElement(),e=d.naturalWidth||1,f=d.naturalHeight||1,g=e/f;1<g?(a=e>b?a:e,b/=g):(a*=g,b=f>b?b:f);d.width=a;d.height=b;this.getFieldObject().dispatchChange();c&&(c.stopPropagation(),c.preventDefault())};
