...
mailmeteor.editor.VariablesPicker.makeMenuButton=function(a,b,c,d){var e=goog.dom.getDomHelper();a=goog.ui.editor.ToolbarFactory.makeMenuButton(a,b,c,d,null,e);a.setScrollOnOverflow(!0);a.queryable=!0;a.setVariables=function(a){var b=new goog.ui.Menu;goog.array.forEach(a||[],function(a){var c=new goog.ui.MenuItem(a);c.setId(mailmeteor.editor.VariablesPicker.COMMAND+"-"+a);b.addItem(c)});this.setMenu(b)};return a};mailmeteor.editor.VariablesPicker.prototype.focusField_=function(){this.getFieldDomHelper().getWindow().focus()};
...
goog.events.InputHandler.prototype.disposeInternal=function(){goog.events.InputHandler.superClass_.disposeInternal.call(this);this.eventHandler_.dispose();this.cancelTimerIfSet_();delete this.element_};goog.ui.TabRenderer=function(){goog.ui.ControlRenderer.call(this)};goog.inherits(goog.ui.TabRenderer,goog.ui.ControlRenderer);goog.addSingletonGetter(goog.ui.TabRenderer);goog.ui.TabRenderer.CSS_CLASS="goog-tab";goog.ui.TabRenderer.prototype.getCssClass=function(){return goog.ui.TabRenderer.CSS_CLASS};goog.ui.TabRenderer.prototype.getAriaRole=function(){return goog.a11y.aria.Role.TAB};
