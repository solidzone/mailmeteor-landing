...
og_image: https://mailmeteor.com/assets/img/blog/gmail-deliverability/gmail-deliverability.png
...
When sending emails with Gmail, there are few things more important to the success of a campaign than achieving solid email deliverability with each email. 
...
![Warm-up your Gmail account](/assets/img/blog/gmail-deliverability/gmail-warm-up.png)
...
![Collect responses and reply back](/assets/img/blog/gmail-deliverability/engagement-gmail-deliverability.png)
...
![Warm-up your Gmail account](/assets/img/blog/gmail-deliverability/mail-merge-gmail-personalize.png)
...
The problem is: nobody is fooled anymore by an email beginning with the age-old personalized greeting *"Hi {% raw %}{{ firstname }}{% endraw %}"*. Though it's a good first step to add a personal touch with your recipient's name, try also taking the advantage of the endless personalization possibilities offered by a mail merge.

Personalizing the subject line is effective when it comes to increasing your deliverability. Here's a good example of a personalized email subject: *"{% raw %}{{ Mutual connection }} recommended we talk"{% endraw %}*
...
![Write like a human](/assets/img/blog/gmail-deliverability/write-emails-like-human.png)
...
![ive your account a profile picture](/assets/img/blog/gmail-deliverability/gmail-add-profile-picture.png)
...
![Don't track opens and clicks ](/assets/img/blog/gmail-deliverability/gmail-remove-tracking.png)
...
![Keep your address list clean and up to date](/assets/img/blog/gmail-deliverability/gmail-email-bounces.png)
...
![Add in an unsubscribe option](/assets/img/blog/gmail-deliverability/mail-merge-gmail-unsubscribe-link.png)
...
![Make sure your messages are authenticated](/assets/img/blog/gmail-deliverability/gmail-spf-dmarc-dkim.png)
...
![Avoid sending too many emails at once](/assets/img/blog/gmail-deliverability/gmail-stagger-emails.png)
